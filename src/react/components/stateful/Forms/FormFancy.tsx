...
export class FormFancy extends Component<Local.FormProps, State> {
  ...
  private handleFieldset = (child: ReactElement<any, any>, handleChangeFn: Local.VoidFn): ReactElement<any, any> => {
